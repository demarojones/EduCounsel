...
const CounselorReports: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        <h1 className="text-2xl font-bold text-gray-800 mb-4 md:mb-0">My Reports</h1>
        <button
          onClick={downloadCSV}
...
// This component is responsible for displaying the reports for counselors.
